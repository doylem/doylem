...
let g:colors_name="desertEx_mtd"

" hi Normal	guifg=gray guibg=grey17 gui=none
hi Normal guifg=#cacdc6 guibg=#1e2426 gui=none
" AlignCtrl default
...
hi Cursor       guibg=#babdb6        gui=none
hi ICursor      guibg=#babdb6        gui=none
" hi ErrorMsg     guifg=white          guibg=red      gui=none
hi ErrorMsg     guifg=#eeeeec        guibg=salmon   gui=none
hi Error        guifg=#eeeeec        guibg=salmon   gui=none
...
hi LineNr       guifg=#757773        gui=none
...
hi Todo         guibg=#757773        guifg=#fcaf3e   gui=none
